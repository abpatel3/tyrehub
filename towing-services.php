<?php
$page_title = "Car Towing Service in Ahmedabad & Gandhinagar | Flatbed Tow Truck | TyreHub";
$page_description = "Tyre hub provides the best car towing service in Ahmedabad. Fast, reliable flatbed vehicle recovery and accident assistance at affordable rates. Call 1800-233-5551.";
$current_page = "towing-services";
...
<!-- ========================================== -->
<!-- 1. DARK HERO BANNER WITH TOWING CARD       -->
<!-- ========================================== -->
<section class="relative py-8 sm:py-12 lg:py-16 xl:py-20 text-white overflow-hidden">
  
  <!-- Towing Hero Backdrop Image -->
  <div class="absolute inset-0 z-0 overflow-hidden pointer-events-none">
    <img src="assets/image/towing-bg.jpg" alt="Car Towing Service in Ahmedabad" class="w-full h-full object-cover object-center absolute inset-0">
  ...
  <div class="container mx-auto px-3 relative z-10">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 text-left space-y-4 sm:space-y-6 order-1 lg:order-2" data-aos="fade-left" data-aos-duration="600">
        ...
        <div>
          <span class="inline-flex items-center gap-2 px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-full border border-amber-400/40 bg-black/40 backdrop-blur-sm text-white font-bold text-[10px] sm:text-xs uppercase tracking-wider">
            <i class="fa-solid fa-truck-pickup text-brand-yellow"></i> SAFE FLATBED VEHICLE RECOVERY
          </span>
        </div>
        ...
        <div>
          <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-outfit leading-[1.15] sm:leading-[1.1]">
            <span class="text-white block">Professional Car Towing</span>
            <span class="text-brand-yellow block mt-1">Right When You Need It.</span>
          </h1>
        </div>

        <p class="text-slate-200 text-xs sm:text-sm md:text-base leading-relaxed max-w-xl font-normal">
          We understand how crucial a tow service is as tow services safeguard and protect your car. TyreHub delivers rapid, zero-damage flatbed car towing and recovery across Ahmedabad and Gandhinagar at transparent rates.
        </p>

        <!-- 3 Circular Feature Badges Row -->
        <div class="flex items-center gap-4 sm:gap-8 lg:gap-10 pt-1 sm:pt-2">
          
          <!-- Badge 1: 30-Min Rapid Dispatch -->
          <div class="flex flex-col items-center text-center">
            ...
            <span class="text-[11px] sm:text-xs md:text-sm font-semibold text-white font-outfit mt-2 sm:mt-2.5">Fast Dispatch</span>
          </div>

          <!-- Badge 2: Hydraulic Flatbed -->
          <div class="flex flex-col items-center text-center">
            <div class="w-14 h-14 sm:w-16 sm:h-16 lg:w-18 lg:h-18 rounded-full hero-feature-circle flex items-center justify-center text-blue-200">
              <svg class="w-6 h-6 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="text-[11px] sm:text-xs md:text-sm font-semibold text-white font-outfit mt-2 sm:mt-2.5">Safe Flatbed</span>
          </div>

          <!-- Badge 3: 100% Safe Recovery -->
          <div class="flex flex-col items-center text-center">
            <div class="w-14 h-14 sm:w-16 sm:h-16 lg:w-18 lg:h-18 rounded-full hero-feature-circle flex items-center justify-center text-blue-200">
              <svg class="w-6 h-6 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="text-[11px] sm:text-xs md:text-sm font-semibold text-white font-outfit mt-2 sm:mt-2.5">Damage Free</span>
          </div>
        ...
        <div class="flex flex-wrap items-center gap-4 sm:gap-6 lg:gap-8 pt-1">
          ...
          <div class="flex items-center gap-2 text-white font-semibold text-xs sm:text-sm">
            ...
            <span>Modern Hydraulic Flatbed Tow Trucks</span>
          </div>
          ...
          <div class="flex items-center gap-2 text-white font-semibold text-xs sm:text-sm">
            ...
            <span>City &amp; Highway Breakdown Recovery</span>
          </div>
          ...
          <div class="flex items-center gap-2 text-white font-semibold text-xs sm:text-sm">
            ...
            <span>Affordable &amp; Transparent Rates</span>
          </div>
      ...
      <!-- Left on Desktop (5 cols) / Bottom on Mobile: Towing Booking Card -->
      <div class="lg:col-span-5 w-full max-w-md mx-auto lg:mx-0 order-2 lg:order-1" data-aos="fade-right" data-aos-duration="600">
        <div class="relative rounded-2xl overflow-hidden shadow-2xl transition-shadow duration-300">
          ...
          <div class="text-white py-3.5 px-4 sm:py-4 sm:px-5 flex items-center justify-between" style="background-color: #242e6d;">
            ...
            <h3 class="text-base sm:text-lg font-bold text-white font-outfit tracking-wide flex-1 text-center pr-6">Towing Services</h3>
          </div>
          ...
          <div class="p-4 sm:p-5 bg-white text-slate-900">
            ...
            <div class="text-center mb-3 sm:mb-3.5">
              <div class="flex items-center justify-center">
                <img src="assets/image/towing-services.webp" alt="Car Towing Service" class="w-full max-w-[240px] sm:max-w-[280px] h-auto object-contain mx-auto">
              </div>
            </div>

            <form id="towing-form" onsubmit="handleTowingSubmit(event)" class="space-y-3">
              ...
              <div class="relative">
                ...
                <input type="text" id="tow-name" name="name" required placeholder="Full Name" 
              ...
              <div class="relative">
                ...
                <input type="tel" id="tow-mobile" name="mobile" required pattern="[0-9]{10}" maxlength="10" placeholder="Mobile Number (10 digits)" 
                  class="w-full pl-10 pr-3.5 py-2.5 sm:py-3 text-xs sm:text-sm border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#242e6d]/20 focus:border-[#242e6d] outline-none transition bg-slate-50/50 text-slate-800 placeholder-slate-400">
              </div>
              ...
              <div class="relative">
                ...
                <input type="text" id="tow-location" name="location" required placeholder="Vehicle Location (City / Area / Landmark)" 
                  class="w-full pl-10 pr-3.5 py-2.5 sm:py-3 text-xs sm:text-sm border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#242e6d]/20 focus:border-[#242e6d] outline-none transition bg-slate-50/50 text-slate-800 placeholder-slate-400">
              </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 space-y-5 text-left" data-aos="fade-right" data-aos-duration="600">
        ...
        <div>
          ...
          <h2 class="text-3xl md:text-4xl font-medium text-brand-blue font-outfit leading-tight">
            Contact us for a <span class="font-bold">quick response and an affordable rate</span>
          </h2>
        ...
        <h3 class="text-lg sm:text-xl font-bold text-brand-blue font-outfit">
          Car Towing Service Ahmedabad
        </h3>

        <p class="text-slate-600 text-xs sm:text-sm md:text-base leading-relaxed font-normal">
          Tyre hub provides the best car towing service in Ahmedabad. We understand how crucial a tow service is as tow services safeguard and protect your car. We have the right set of equipment that is required to get the work done robustly, efficiently and effectively. Wave goodbye to all your towing related tensions as Tyre hub has got you covered.
        </p>
      ...
      <div class="lg:col-span-5 flex items-center justify-center" data-aos="fade-left" data-aos-duration="600">
        <div class="relative group max-w-md">
          ...
          <img src="assets/image/Mascot.png" alt="TyreHub Towing Specialist Mascot" class="w-full h-auto object-contain relative z-10 drop-shadow-2xl group-hover:scale-105 transition-transform duration-300">
        </div>
      </div>
  ...
  <div class="container mx-auto px-3 text-center relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
      ...
      <div class="flex flex-col items-center" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
        ...
        <h3 class="text-base font-bold text-white mt-1">Book or Call Toll-Free</h3>
        <p class="text-xs text-slate-300 mt-1 max-w-xs leading-relaxed">
          Submit your vehicle location and destination, or call 1800-233-5551.
        </p>
      </div>
      ...
      <div class="flex flex-col items-center" data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">
        <div class="w-22 h-22 sm:w-24 sm:h-24 rounded-full bg-brand-yellow/20 border-2 border-brand-yellow flex items-center justify-center text-brand-yellow text-2xl sm:text-3xl mb-4 relative shadow-glow-yellow mx-auto">
          <i class="fa-solid fa-truck-pickup" aria-hidden="true"></i>
        ...
        <h3 class="text-base font-bold text-white mt-1">Flatbed Truck Dispatched</h3>
        <p class="text-xs text-slate-300 mt-1 max-w-xs leading-relaxed">
          Nearest heavy-duty hydraulic flatbed vehicle is dispatched to your spot.
        </p>
      </div>
      ...
      <div class="flex flex-col items-center" data-aos="fade-up" data-aos-duration="600" data-aos-delay="300">
        ...
        <h3 class="text-base font-bold text-white mt-1">Safe Load &amp; Delivery</h3>
        <p class="text-xs text-slate-300 mt-1 max-w-xs leading-relaxed">
          Secured with wheel harnesses and transported safely to your chosen destination.
        </p>
      </div>
...
<!-- ========================================== -->
<!-- 5. WHAT WE COVER TOWING SERVICES GRID      -->
<!-- ========================================== -->
  ...
  <div class="container mx-auto px-3">
    ...
    <div class="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
      ...
      <h2 class="text-3xl md:text-4xl font-medium text-brand-blue font-outfit mt-1">
        Comprehensive <span class="font-bold">Towing Capabilities</span>
      </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
      ...
      <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        ...
        <h3 class="text-base font-bold text-slate-900 font-outfit mb-2">Flatbed Car Towing</h3>
        <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
          Full platform loading preventing bumper scraping, drivetrain wear, or suspension stress for luxury, EV, and automatic cars.
        </p>
      </div>

      <!-- Card 2: Accident & Breakdown Recovery -->
      <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        <div class="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center text-xl mb-4">
          <i class="fa-solid fa-triangle-exclamation"></i>
        </div>
        <h3 class="text-base font-bold text-slate-900 font-outfit mb-2">Accident &amp; Breakdown Recovery</h3>
        <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
          Emergency winching and safe roadside extraction for immobilized vehicles on city streets and state highways.
        </p>
      </div>

      <!-- Card 3: Long Distance Towing -->
      <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        <div class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center text-xl mb-4">
          <i class="fa-solid fa-road"></i>
        </div>
        <h3 class="text-base font-bold text-slate-900 font-outfit mb-2">Inter-City Long Distance Transport</h3>
        <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
          Door-to-door vehicle relocation between Ahmedabad, Gandhinagar, Vadodara, Rajkot, and neighboring regions.
        </p>
      </div>

      <!-- Card 4: Basement & Low-Clearance Towing -->
      <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        <div class="w-12 h-12 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center text-xl mb-4">
          <i class="fa-solid fa-warehouse"></i>
        </div>
        <h3 class="text-base font-bold text-slate-900 font-outfit mb-2">Basement Parking Recovery</h3>
        <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
          Specialized wheel-lift equipment capable of navigating underground mall or apartment basements with low height clearance.
        </p>
      </div>

      <!-- Card 5: EV & Hybrid Vehicle Towing -->
      <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        <div class="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center text-xl mb-4">
          <i class="fa-solid fa-charging-station"></i>
        </div>
        <h3 class="text-base font-bold text-slate-900 font-outfit mb-2">EV &amp; Automatic Drivetrain Safe</h3>
        <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
          Strict wheel-free loading protocol ensuring regenerative braking and dual-motor electric vehicle batteries remain protected.
        </p>
      </div>

      <!-- Card 6: Insurance & Workshop Towing -->
      <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
        <div class="w-12 h-12 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center text-xl mb-4">
          <i class="fa-solid fa-shield-halved"></i>
        </div>
        <h3 class="text-base font-bold text-slate-900 font-outfit mb-2">Insurance Tie-Up &amp; Garage Drops</h3>
        <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
          Hassle-free direct towing to your preferred authorized workshop or TyreHub service center with digital delivery proof.
        </p>
      </div>
    ...
    <div class="bg-brand-blueDark text-white p-6 sm:p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg border border-white/10" data-aos="fade-up" data-aos-duration="600">
      <div class="space-y-1.5 text-center md:text-left">
        <span class="inline-block px-2.5 py-0.5 rounded bg-brand-yellow text-slate-950 font-black text-[10px] uppercase tracking-wider mb-1">
          24/7 Roadside Tow Support
        </span>
        <h3 class="text-xl sm:text-2xl font-bold font-outfit text-white">Need Urgent Car Towing in Ahmedabad?</h3>
        <p class="text-slate-200 text-xs sm:text-sm max-w-2xl leading-relaxed">
          Service is available between 9:30 AM to 6:30 PM Mon to Sat. Contact our dedicated dispatch team right now.
        </p>
      </div>
...
<script>
function handleTowingSubmit(e) {
  e.preventDefault();
  
  const name = document.getElementById('tow-name').value.trim();
  const mobile = document.getElementById('tow-mobile').value.trim();
  const location = document.getElementById('tow-location').value.trim();
  
  const serviceSummary = `Car Towing Assistance - ${name} | Loc: ${location}`;
  
  if (typeof openBookingModal === 'function') {
    openBookingModal(serviceSummary);
  } else {
    alert(`Thank you, ${name}! Your request for Car Towing Service at ${location} has been received. Our towing rescue team will call you on ${mobile} immediately.`);
    document.getElementById('towing-form').reset();
  }
}
</script>
